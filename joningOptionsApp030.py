...
def set_font_size(size):
    ...
    # Apply font size to other widgets
    for widget in [load_data1_button, load_data2_button, join_button, increase_font_button, decrease_font_button, sort_button] + menu_labels:
...
# Filename labels aligned to the right edge of Data 1 and Data 2 boxes
data1_file_label = tk.Label(root, textvariable=data1_filename, fg="gray", anchor="e")
data1_file_label.grid(row=3, column=0, sticky="e", padx=(0, 5))

data2_file_label = tk.Label(root, textvariable=data2_filename, fg="gray", anchor="e")
data2_file_label.grid(row=3, column=1, sticky="e", padx=(0, 5))

# Join Result label
join_result_label = tk.Label(root, text="Join Result")
join_result_label.grid(row=5, column=0, columnspan=7, sticky="w")

# Data display Treeviews filling 95% of the main window width
data1_tree = ttk.Treeview(root, show='headings', style="Treeview")
data1_tree.grid(row=4, column=0, columnspan=3, padx=5, pady=5, sticky="nsew")

data2_tree = ttk.Treeview(root, show='headings', style="Treeview")
data2_tree.grid(row=4, column=3, columnspan=3, padx=5, pady=5, sticky="nsew")
